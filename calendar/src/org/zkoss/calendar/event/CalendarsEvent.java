...
public class CalendarsEvent extends Event {
	...
	public CalendarsEvent(String name, Component target, CalendarEvent ce,
		...
		_dtwd = dtwd;
		_dthgh = dthgh;
		((AbstractComponent)target).smartUpdate("z.cleardd", true);
	}
	...
	public void stopClearGhost() {
		((AbstractComponent)getTarget()).smartUpdate("z.cleardd", false);
	}
	...
	public void clearGhost() {
		((AbstractComponent)getTarget()).smartUpdate("z.cleardd", true);
	}
