...
/**
 * A renderer of {@link Calendars} renders the outline in both views, default and
 * month.
 * @author jumperchen
 *
 */
public class CalendarsDefault implements ComponentRenderer {
	...
	private void getDayView(Calendars self, Writer out) throws IOException {
		final SmartWriter wh = new SmartWriter(out);
		// day view
		final String uuid = self.getUuid();
